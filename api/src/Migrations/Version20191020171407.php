 ...
 */
final class Version20191020171407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_verification_request (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, comment CLOB DEFAULT NULL COLLATE BINARY, status VARCHAR(63) NOT NULL COLLATE BINARY, idimage_path VARCHAR(511) DEFAULT NULL, CONSTRAINT FK_9EDC0C31A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_verification_request AS SELECT id, user_id, idimage_path, comment, status FROM user_verification_request');
        $this->addSql('DROP TABLE user_verification_request');
        $this->addSql('CREATE TABLE user_verification_request (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, comment CLOB DEFAULT NULL, status VARCHAR(63) NOT NULL, idimage_path VARCHAR(511) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO user_verification_request (id, user_id, idimage_path, comment, status) SELECT id, user_id, idimage_path, comment, status FROM __temp__user_verification_request');
        $this->addSql('DROP TABLE __temp__user_verification_request');
        $this->addSql('CREATE INDEX IDX_9EDC0C31A76ED395 ON user_verification_request (user_id)');
    }
